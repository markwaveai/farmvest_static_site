    ...
    return (
        ...
        >
            <div className="w-full px-4 md:px-8 flex justify-between items-center">
                    ...
                    {navLinks.map((link) => (
                        <Link
                            ...
                            className={cn(
                                ...
                                (scrolled || location.pathname === '/contact-us') ? "text-gray-600" : "text-gray-200"
                            )}
                        >
                ...
                >
                    {isOpen ? <X className="w-6 h-6" /> : <Menu className={cn("w-6 h-6", (scrolled || location.pathname === '/contact-us') ? "text-slate-900" : "text-white")} />}
                </button>
            </div>
